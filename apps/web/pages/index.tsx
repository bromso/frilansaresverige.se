              ...
              <div className="squircle relative flex flex-1 flex-col overflow-hidden rounded-3xl text-left lg:rounded-tr-4xl">
                ...
                <div className="relative z-10 flex flex-1 flex-col p-8 text-brand-grey">
                  ...
                  <div className="mt-auto pt-6">
                    <div className="flex items-center gap-3 rounded-2xl bg-white/40 p-3 shadow-[inset_0_0_0_1px_rgba(38,1,187,0.12)] backdrop-blur-sm">
                      <span
                        aria-hidden="true"
                  ...
                  <div className="mt-auto flex items-center gap-4 pt-6">
                    <div className="flex shrink-0" aria-hidden="true">
                      {KONSULT_AVATARS.map((initials, index) => (
                        <span
                          key={initials}
                          className={`font-display flex size-11 items-center justify-center rounded-full bg-brand-coral text-sm font-bold text-brand-grey ring-2 ring-white ${index > 0 ? '-ml-3' : ''}`}
                        >
                          {initials}
                        </span>
                      ))}
                      <span className="font-display -ml-3 flex size-11 items-center justify-center rounded-full bg-brand-blue-dark text-xs font-bold text-[#fffce3] ring-2 ring-white">
                        {memberCount
