...
// Animate UI's Radix checkbox primitive (animate-ui.com): the box is a
// motion button that scales on hover/press, and the indicator draws the
// check mark with a pathLength animation. Vendored as-is apart from this
