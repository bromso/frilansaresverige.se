...
function TooltipOverlay() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies(rendered.data): the library intentionally re-anchors and repositions when a new tooltip's data arrives
...
function TooltipContent({ asChild = false, ...props }: TooltipContentProps) {
  ...
  React.useEffect(() => {
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: the shallow-equal guard above is the library's own defence against the unstable rest-props object
  }, [props, setProps])
